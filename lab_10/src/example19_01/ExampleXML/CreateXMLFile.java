package example19_01.ExampleXML;
...
public class CreateXMLFile {
    public static void main(String[] args) {
        try {
            ...
            javax.xml.transform.stream.StreamResult result = new javax.xml.transform.stream.StreamResult(new File("lab_10\\src\\example19_01\\ExampleXML\\example.xml"));
